// edit-diff.ts — vendored from refs/pi packages/coding-agent
// src/core/tools/edit-diff.ts (MIT License, Copyright (c) 2025 Mario Zechner;
// see refs/pi/LICENSE). Copied verbatim except the fs-backed preview fns
// computeEditsDiff/computeEditDiff are omitted: previews run against
// ComputerExecutionEnv in tools.ts instead, so no node:fs travels.

...
- [Backstory](./backstory.md) — persistent bot persona: per-session system prompt seam, spawn template, meta?systemPrompt=1, cap, restart persistence. Activates PR56.
